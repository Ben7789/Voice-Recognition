...
mfcc_extractor_test = extract_mfcc(test_signal, test_sample_rate, n_mfcc=20)
test_features_standardized = scaler.fit_transform(mfcc_extractor_test)
test_principal_component = pca(test_features_standardized)
...
plt.scatter(test_principal_component[0, 0], test_principal_component[0, 1], color='yellow', marker='o', s=100, label='Test Sample')'''
